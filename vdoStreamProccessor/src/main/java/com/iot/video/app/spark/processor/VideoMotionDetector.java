...
public class VideoMotionDetector implements Serializable {	
	 ...
	 */
	public static VideoEventData detectMotion(String camId, Iterator<VideoEventData> frames, String outputDir, VideoEventData previousProcessedEventData) {
